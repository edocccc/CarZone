...
@NgModule({
  declarations: [AppComponent, LoginComponent, RegistrazioneComponent, HomepageClienteComponent, DettagliVeicoloComponent, HomepageDipendenteComponent, HomepageManagerComponent, PrenotazioneVeicoloComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
    FormsModule,
